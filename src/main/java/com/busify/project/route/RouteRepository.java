...
//     @Query("SELECT new com.busify.project.route.dto.RouteResponse(r.routeId, CONCAT(l1.name, ' → ', l2.name), " +
//            "CAST(CEIL(r.defaultDurationMinutes / 60.0) || '–' || CEIL(r.defaultDurationMinutes / 60.0 + 1) || ' hours' AS string), " +
//            "r.defaultPrice) " +
//            "FROM Route r " +
