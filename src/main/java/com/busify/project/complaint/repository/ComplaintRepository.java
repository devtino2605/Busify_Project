...
public interface ComplaintRepository extends JpaRepository<Complaint, Long> {
        ...
        long countByAssignedAgent_IdAndStatusAndCreatedAtBetween(Long agentId, ComplaintStatus status,
                        LocalDateTime start,
                        LocalDateTime end);

        // Đếm số complaint theo agent, trạng thái, và khoảng thời gian dựa trên
        // updatedAt
        long countByAssignedAgent_IdAndStatusAndUpdatedAtBetween(Long agentId, ComplaintStatus status,
                        LocalDateTime start,
                        LocalDateTime end);
        ...
        // Paginated version of findAllByAssignedAgent
        Page<Complaint> findAllByAssignedAgentOrderByCreatedAtDesc(User assignedAgent, Pageable pageable);

        // Paginated version of findAllByAssignedAgentAndStatus
        Page<Complaint> findAllByAssignedAgentAndStatusOrderByCreatedAtDesc(User assignedAgent, ComplaintStatus status,
                        Pageable pageable);
