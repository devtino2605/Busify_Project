...
-- 1. First, insert base data with no foreign key dependencies
...
-- 3. Insert data that depends on previous entities
...
-- 5. Insert audit logs last since they reference many other entities
