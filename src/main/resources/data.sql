...
(1, 'CREATE_BOOKING', '{\"booking_code\": \"BOOK123\"}', 'BOOKING', 1, '2025-07-24 12:00:00.000000', 2),
...
INSERT INTO `bookings` (`id`, `booking_code`, `created_at`, `guest_address`, `guest_email`, `guest_full_name`, `guest_phone`, `seat_number`, `status`, `total_amount`, `updated_at`, `agent_accept_booking_id`, `customer_id`, `trip_id`) VALUES
(1, 'BOOK123', '2025-07-24 12:00:00.000000', '456 Nguyễn Trãi, TP.HCM', 'customer1@busify.com', 'Trần Thị Khách', '0987654321', 'A1', 'confirmed', 500000.00, '2025-07-24 12:00:00.000000', NULL, 2, 1),
...
(4, 'BOOK126', '2025-07-24 15:00:00.000000', '90 Lý Thường Kiệt, Cần Thơ', 'customer4@busify.com', 'Hoàng Văn Khách', '0954321098', 'C1', 'confirmed', 200000.00, '2025-07-24 15:00:00.000000', NULL, 9, 4),
...
INSERT INTO `buses` (`id`, `amenities`, `license_plate`, `model`, `status`, `total_seats`, `operator_id`, `seat_layout_id`) VALUES
(1, '{\"wifi\": true, \"air_conditioner\": true}', '51B-12345', 'Hyundai Universe', 'active', 40, 1, 1),
(2, '{\"wifi\": true, \"air_conditioner\": true, \"usb_charging\": true}', '51B-67890', 'Thaco Mobihome', 'active', 32, 2, 2),
...
(5, '{\"wifi\": true, \"air_conditioner\": true, \"tv\": true}', '51B-11223', 'Mercedes Sprinter', 'active', 32, 5, 2),
...
INSERT INTO `bus_operators` (`operator_id`, `address`, `created_at`, `description`, `email`, `hotline`, `license_path`, `name`, `status`, `updated_at`, `owner_id`) VALUES
(1, '789 Lê Lợi, Đà Nẵng', '2025-07-24 10:00:00.000000', 'Nhà xe uy tín', 'operator@busify.com', '0901234567', '/licenses/operator1.pdf', 'Nhà Xe ABC', 'active', '2025-07-24 10:00:00.000000', 3),
(2, '12 Phạm Ngọc Thạch, Đà Lạt', '2025-07-24 11:00:00.000000', 'Nhà xe chất lượng cao', 'operator2@busify.com', '0931234567', '/licenses/operator2.pdf', 'Nhà Xe XYZ', 'active', '2025-07-24 11:00:00.000000', 5),
(3, '45 Nguyễn Văn Cừ, Huế', '2025-07-24 11:00:00.000000', 'Dịch vụ thân thiện', 'operator3@busify.com', '0932234567', '/licenses/operator3.pdf', 'Nhà Xe Huế', 'pending_approval', '2025-07-24 11:00:00.000000', 5),
(4, '67 Trần Hưng Đạo, Cần Thơ', '2025-07-24 11:00:00.000000', 'Nhà xe uy tín miền Tây', 'operator4@busify.com', '0933234567', '/licenses/operator4.pdf', 'Nhà Xe Miền Tây', 'active', '2025-07-24 11:00:00.000000', 5),
(5, '89 Võ Thị Sáu, Vũng Tàu', '2025-07-24 11:00:00.000000', 'Chuyến xe an toàn', 'operator5@busify.com', '0934234567', '/licenses/operator5.pdf', 'Nhà Xe Biển Xanh', 'active', '2025-07-24 11:00:00.000000', 5),
(6, '101 Lê Lai, Nha Trang', '2025-07-24 11:00:00.000000', 'Dịch vụ cao cấp', 'operator6@busify.com', '0935234567', '/licenses/operator6.pdf', 'Nhà Xe Nha Trang', 'active', '2025-07-24 11:00:00.000000', 5);
...
(1, '2025-07-25 22:00:00.000000', 'Ghế không thoải mái', 'New', 'Khiếu nại về ghế', '2025-07-25 22:00:00.000000', NULL, 1, 2),
...
INSERT INTO `employees` (`driver_license_number`, `employee_type`, `id`, `operator_id`) VALUES
('DL123456', 'DRIVER', 4, 1),
('DL678901', 'DRIVER', 8, 2);
...
INSERT INTO `promotions` (`promotion_id`, `code`, `discount_type`, `discount_value`, `end_date`, `start_date`, `status`, `usage_limit`) VALUES
(1, 'DISCOUNT10', 'PERCENTAGE', 10.00, '2025-08-01', '2025-07-24', 'active', 100);
...
(1, 'Chuyến đi tuyệt vời!', '2025-07-25 21:00:00.000000', 5, 2, 1),
...
(1, 720, 500000.00, 'TP.HCM - Hà Nội', 2, 1),
...
INSERT INTO `users` (`id`, `email`, `password_hash`, `refresh_token`, `role_id`) VALUES
('customer1@busify.com', '$2a$10$exampleHash', NULL, NULL),
('operator@busify.com', '$2a$10$exampleHash', NULL, NULL),
('driver@busify.com', '$2a$10$exampleHash', NULL, NULL),
('operator2@busify.com', '$2a$10$exampleHash', NULL, NULL),
('customer2@busify.com', '$2a$10$exampleHash', NULL, NULL),
('customer3@busify.com', '$2a$10$exampleHash', NULL, NULL),
('driver2@busify.com', '$2a$10$exampleHash', NULL, NULL),
('customer4@busify.com', '$2a$10$exampleHash', NULL, NULL);
...
--
ALTER TABLE `bus_operators`
  MODIFY `operator_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `complaints`
--
ALTER TABLE `complaints`
  MODIFY `complaints_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `locations`
--
ALTER TABLE `locations`
  MODIFY `location_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `routes`
  MODIFY `route_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `trips`
  MODIFY `trip_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `tickets`
  ADD CONSTRAINT `FKbcjlnu2low7r5vfimxextqab9` FOREIGN KEY (`trip_id`) REFERENCES `trips` (`trip_id`),
